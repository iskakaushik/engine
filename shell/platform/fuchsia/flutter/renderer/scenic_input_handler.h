...
#ifndef FLUTTER_SHELL_PLATFORM_FUCHSIA_RENDERER_SCENIC_INPUT_HANDLER_H_
#define FLUTTER_SHELL_PLATFORM_FUCHSIA_RENDERER_SCENIC_INPUT_HANDLER_H_
...
class ScenicInputHandler final
 ...
 public:
  ...
  ScenicInputHandler(const ScenicInputHandler&) = delete;
  ScenicInputHandler(ScenicInputHandler&&) = delete;
  ~ScenicInputHandler() = default;

  ScenicInputHandler& operator=(const ScenicInputHandler&) = delete;
  ScenicInputHandler& operator=(ScenicInputHandler&&) = delete;
...
#endif  // FLUTTER_SHELL_PLATFORM_FUCHSIA_RENDERER_SCENIC_INPUT_HANDLER_H_
